...
# Khi DAG chạy các tasks trong QK, nó tự tạo ra các simulated dates. Trong task load_trip_data_to_redshift, dùng **kwarg để extract simulated execution date
# và dùng nó để lấy data của date này. Nó sẽ load paritioned data trong S3 với year và month cụ thể, tránh load toàn bộ data.