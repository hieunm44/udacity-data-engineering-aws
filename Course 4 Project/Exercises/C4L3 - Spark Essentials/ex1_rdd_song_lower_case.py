...
# TODO: parallelize the log_of_songs to use with Spark
...
# TODO: show the original input data is preserved
...
# TODO: use the map function to transform the list of songs with the python function that converts strings to lowercase
...
# TODO: Show the original input data is still mixed case
distributed_song_log_rdd.foreach(print)

# TODO: Use lambda functions instead of named functions to do the same map operation
