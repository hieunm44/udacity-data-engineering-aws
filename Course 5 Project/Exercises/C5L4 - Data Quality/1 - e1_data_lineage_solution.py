...
# Ta có thể trace lineage, cụ thể là khi có error trong flow, ta trace back theo data flow tới source. VD, có một potential error ở load_trip_data_to_redshift, ta vào SQL kiểm tra.